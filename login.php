...
<body>
  ...
  <div class="col-lg-6 login-btm login-button">
    <a href="registrasi.php"><button type="button" class="btn btn-outline-primary">Registration</button></a>
  </div>
                ...
                <div class="card-3d-wrapper">
                  <div class="card-front">
                    <div class="center-wrap">
                      <div class="section text-center login-form" id="login-form">
                        <h4 class="mb-4 pb-3 login-form" id="login-form">Log In</h4>
