                ...
                <div class="card-img-overlay">
                  <div class="card text-dark bg-light mb-3" style="max-width: 22rem; height: 13.5rem;">
                    <div class="card-body">
                      ...
                      <div class="col-md-20">
                        <img src="image/ds1.jpg" class="img-fluid rounded-start" alt="..." style="max-width: 12rem; height: 8.5rem;">
                        <p class="card-text">
                          Bery Piece
                ...
                <div class="card-img-overlay">
                  <div class="card text-dark bg-light mb-3" style="max-width: 22rem; height: 13.5rem;">
                    <div class="card-body">
                      ...
                      <div class="col-md-20">
                        <img src="image/ds4.jpg" class="img-fluid rounded-start" alt="..." style="max-width: 12rem; height: 8.5rem;">
                        <p class="card-text">
                          Bery Slice
                ...
                <div class="card-img-overlay">
                  <div class="card text-dark bg-light mb-3" style="max-width: 22rem; height: 13.5rem;">
                    <div class="card-body">
                      ...
                      <div class="col-md-20">
                        <img src="image/ds5.jpg" class="img-fluid rounded-start" alt="..." style="max-width: 12rem; height: 8.5rem;">
                        <p class="card-text">
                          Sandwich
                          <strong>Rp.25.000,-</strong>
                        </p>
                ...
                <div class="card-img-overlay">
                  <div class="card text-dark bg-light mb-3" style="max-width: 22rem; height: 13.5rem;">
                    <div class="card-body">
                      ...
                      <div class="col-md-20">
                        <img src="image/ds6.jpg" class="img-fluid rounded-start" alt="..." style="max-width: 12rem; height: 8.5rem;">
                        <p class="card-text">
                          Cheese Spons
                ...
                <div class="card-img-overlay">
                  <div class="card text-dark bg-light mb-3" style="max-width: 22rem; height: 13.5rem;">
                    <div class="card-body">
                      ...
                      <div class="col-md-20">
                        <img src="image/ds7.jpg" class="img-fluid rounded-start" alt="..." style="max-width: 12rem; height: 8.5rem;">
                        <p class="card-text">
                          Buble Cake
                ...
                <div class="card-img-overlay">
                  <div class="card text-dark bg-light mb-3" style="max-width: 22rem; height: 13.5rem;">
                    <div class="card-body">
                      ...
                      <div class="col-md-20">
                        <img src="image/ds8.jpg" class="img-fluid rounded-start" alt="..." style="max-width: 12rem; height: 8.5rem;">
                        <p class="card-text">
                          Brown Teddy
